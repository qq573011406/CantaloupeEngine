...
Onion::Allocator::Allocator(size_t data_size, size_t page_size, size_t alignment)
	: m_pPageList(nullptr), m_pFreeList(nullptr)
{
...
void Onion::Allocator::Reset(size_t data_size, size_t page_size, size_t alignment)
{
	FreeAll();
...
void Onion::Allocator::Free(void* p)
{
...
#if defined(_DEBUG)
void Onion::Allocator::FillFreePage(PageHeader *pPage)
{
	// page header
	pPage->pNext = nullptr;
...
void Onion::Allocator::FillFreeBlock(BlockHeader *pBlock)
{
	// block header + data
...
void Onion::Allocator::FillAllocatedBlock(BlockHeader *pBlock)
{
	// block header + data
...
Onion::BlockHeader* Onion::Allocator::NextBlock(BlockHeader *pBlock)
{
