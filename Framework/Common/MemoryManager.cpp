...
int Onion::MemoryManager::Initialize()
{
...
void Onion::MemoryManager::Finalize()
{
    delete[] m_pAllocators;
    delete[] m_pBlockSizeLookup;
}

void Onion::MemoryManager::Tick()
{
}

Allocator* Onion::MemoryManager::LookUpAllocator(size_t size)
{
...
void* Onion::MemoryManager::Allocate(size_t size)
{
...
void Onion::MemoryManager::Free(void* p, size_t size)
{
    Allocator* pAlloc = LookUpAllocator(size);
    if (pAlloc)
        pAlloc->Free(p);
