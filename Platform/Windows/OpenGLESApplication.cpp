...
int Onion::OpenGLESApplication::Initialize()
{
    int result = 0;
...
void Onion::OpenGLESApplication::Finalize()
{
    if (m_RenderContext) {
...
void Onion::OpenGLESApplication::Tick()
{
    WindowsApplication::Tick();
}

void Onion::OpenGLESApplication::SwapBuffer()
{
	SwapBuffers(mHDC);
}